      ...
      >
        ...
        <div className="px-5 py-5 border-b" style={{ borderColor: "rgba(30,58,95,0.6)" }}>
          <div className="flex items-center gap-3">
            <img src="/logo-unkhair.png" alt="Logo Universitas Khairun" className="w-9 h-9 object-contain flex-shrink-0" />
            <div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        >
          ...
          <div className="flex items-center gap-2 md:hidden">
            <img src="/logo-unkhair.png" alt="Logo Universitas Khairun" className="w-7 h-7 object-contain" />
